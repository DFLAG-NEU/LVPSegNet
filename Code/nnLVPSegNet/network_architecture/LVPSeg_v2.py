...
#2 分支代表 high to low
        ...
        if self.fusion_mode==1:
            ...
            self.final_conv = nn.Conv2d(class_num * 2, class_num, 1, dilation=1)
    ...
    def forward(self, x):
        ...
        if self.fusion_flag:
            ...
            elif self.direction=='H2L':
                g1_out=F.relu(self.inter1_1bn(self.inter1_1(tmp)))
        ...
        if self.fusion_flag:
            ...
            if self.direction=='L2H':
                ...
                g1_out=F.relu(self.inter1_1bn_plus(self.inter1_1_plus(tmp)))
            elif self.direction=='B':
                g1_out=F.relu(self.inter1_1bn_plus(self.inter1_1_plus(tmp)))
                g2_net5 = F.relu(self.inter1_2bn_plus(self.inter1_2_plus(tmp)))
        ...
        if self.fusion_flag:
            ...
            if self.direction=='L2H':
                ...
                g1_out = F.relu(self.inter2_1bn(self.inter2_1(tmp)))  # CRFB
            elif self.direction=='B':
                g1_out = F.relu(self.inter2_1bn(self.inter2_1(tmp)))  # CRFB
                g2_net7 = F.relu(self.inter2_2bn(self.inter2_2(tmp)))  # CRFB
        ...
        if self.fusion_flag:
            ...
            if self.direction=='L2H':
                ...
                g1_out = F.relu(self.inter2_1bn_plus(self.inter2_1_plus(tmp)))  # CRFB
            elif self.direction=='B':
                g1_out = F.relu(self.inter2_1bn_plus(self.inter2_1_plus(tmp)))  # CRFB
                g2_net9 = F.relu(self.inter2_2bn_plus(self.inter2_2_plus(tmp)))  # CRFB
        ...
        if self.fusion_flag:
            ...
            if self.direction=='L2H':
                ...
                g1_out = F.relu(self.inter3_1bn(self.inter3_1(tmp)))  # CRFB
            elif self.direction=='B':
                g1_out = F.relu(self.inter3_1bn(self.inter3_1(tmp)))  # CRFB
                g2_net11 = F.relu(self.inter3_2bn(self.inter3_2(tmp)))  # CRFB
...
class final_seg_net(SegmentationNetwork):
    def __init__(self,class_num=1):
        ...
        #no softmax
        self.model=kiSTSN_plus(class_num,softmax_flag=False,fusion_mode=1)
