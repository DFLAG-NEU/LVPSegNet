...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        self.best_epoch_based_on_MA_val_value=0
    ...
    def run_training(self):
        ...
        self.print_to_log_file(self.best_epoch_based_on_MA_val_value)
    ...
    def manage_patience(self):
        ...
        if self.patience is not None:
            ...
            if self.val_eval_criterion_MA > self.best_val_eval_criterion_MA:
                ...
                self.best_epoch_based_on_MA_val_value=self.epoch
                self.print_to_log_file(self.epoch)#save the current epoch num
