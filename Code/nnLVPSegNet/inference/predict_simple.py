...
from nnunet.common import join, isdir
...
def main():
    ...
    sys.argv = [r'predict_simple.py',
                "-i", r"/home/fengteam/lsl/M4D27/nnUnet-OnWindows-main/nnunet/Data/nnUNet_raw_data_base/nnUNet_raw_data/Task914_MI/imagesTs",
                "-o", r"/home/fengteam/lsl/M4D27/nnUnet-OnWindows-main/nnunet/Data/nnUNet_raw_data_base/nnUNet_raw_data/Task914_MI/inferTs_CL",
                "-t", "Task914_MI",
                "-tr", "nnUNetTrainer_LVPv2",
                "-f", "0",
                "-m", "2d",
                '-chk', "model_best",
                ]
...
def main_test(input,output,task):
    import sys
    parser = argparse.ArgumentParser()
    # parser.add_argument("-i", '--input_folder', help="Must contain all modalities for each patient in the correct"
    #                                                  " order (same as training). Files must be named "
...
if __name__ == "__main__":
    ...
    # sys.argv = [r'predict_simple.py',
    #             "-i", r"/home/fengteam/lsl/M4D27/nnUnet-OnWindows-main/nnunet/Data/nnUNet_raw_data_base/nnUNet_raw_data/Task901_MIS2_0/imagesTr",
    #             "-o", r"/home/fengteam/lsl/M4D27/nnUnet-OnWindows-main/nnunet/Data/nnUNet_raw_data_base/nnUNet_raw_data/Task901_MIS2_0/inferTr",
    #             "-t", "Task901_MIS2_0",
    #             "-tr", "nnUNetTrainer_LVPv2",
    #             "-f", "0",
    #             "-m", "2d",
    ...
    if mode=='CL_train':
        stage=3
        for fold in [1,2,3,4]:
            task_id='9%d%d'%(fold,stage)
            main_task_id='9%d%d'%(fold,0)
            input_dir="/home/fengteam/lsl/M4D27/nnUnet-OnWindows-main/nnunet/Data/nnUNet_raw_data_base/nnUNet_raw_data/Task%s_MI/imagesTr"%main_task_id
            output_dir="/home/fengteam/lsl/M4D27/nnUnet-OnWindows-main/nnunet/Data/nnUNet_raw_data_base/nnUNet_raw_data/Task%s_MI/inferTr"%task_id
            task="Task%s_MI"%task_id

            main_CL(input=input_dir,output=output_dir,task=task)
    elif mode=='test':
        main()
        # fold_list=[1,2,3,4]
        fold_list=[1]
        for fold in fold_list:
            task_id = '9%d%d' % (fold, 4)

            input_dir = "/home/fengteam/lsl/M4D27/nnUnet-OnWindows-main/nnunet/Data/nnUNet_raw_data_base/nnUNet_raw_data/Task914_MI/imagesTs"
            output_dir = "/home/fengteam/lsl/M4D27/nnUnet-OnWindows-main/nnunet/Data/nnUNet_raw_data_base/nnUNet_raw_data/Task914_MI/inferTs_CL"

            task = "Task%s_MI" % task_id

            main_test(input=input_dir,output=output_dir,task=task)
